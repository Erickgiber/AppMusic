...
const portada = () => {
    ...
    portada.innerHTML = `
        <div style="
            ...
            background-size: cover;
            background-position: center;
            background-image: url(https://i.ibb.co/MRyJTmn/094809-889412.jpg);
        ">  </div>
...
<div>
    ...
    <div id="playpausebtn">
        ...
        <i class="fas fa-pause" style="display:none;" onclick="playy(this);"></i>
        <i class="fas fa-play" onclick="pausee(this)"></i>
